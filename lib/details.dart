...
void main() {
  // MyApp Represente la porte d'entrer de mon application
  runApp(MyApp());
}
...
// La methode build ici nous aide à savoir comment est-ce que on va construire cette Application
// ICI on definit les elements principaux de mon application
  @override
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      // Le theme de notre application, dans notre cas c'est la couleur blue mais on peux la changer en modifiant la valeur de "primarySwatch" à une autre couleur
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      // Home represente la premiere page de mon application dans notre cas c'est la page d'acceuil, cette application n'a qu'une seule page et cette page est representer par la classe MyHomePage
      home: MyHomePage(
